...
public class ExListViewScrollDone extends ListView {
    ...
    private static final String TAG = ExListViewScrollDone.class.getSimpleName();
    ...
    public ExListViewScrollDone(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ExListViewScrollDone(Context context, AttributeSet attrs, int defStyleAttr) {
