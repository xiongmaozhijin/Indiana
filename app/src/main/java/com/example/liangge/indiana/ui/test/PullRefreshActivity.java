...
public class PullRefreshActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        LastestBingoEntity item1 = new LastestBingoEntity(2313, 21,21,url1, "titledesc惠普电脑1irb1", "tom", "123212", 10, System.currentTimeMillis() + 50*1000, 1);
        LastestBingoEntity item2 = new LastestBingoEntity(41321,21,21,url2, "title乐视电视descirb2", "小李", "941212", 1, System.currentTimeMillis() + 10*1000, 1);
        LastestBingoEntity item3 = new LastestBingoEntity(3243241,21,21, url3, "titledes小米手机irb2", "张李", "321212", 1, System.currentTimeMillis() + 100*1000, 1);
        ...
        for (int i=0; i<10; i++) {
            ...
            entity = new LastestBingoEntity(3413,21,21,imgs[i%5], "titleDescribe"+i, "user_for"+i, random+"", i, time1, 1);

            mListLatestDatas.add(entity);
        }

        item1 = new LastestBingoEntity(331231, 21,21,url4, "titledesc惠普电脑1irb1", "tom", "123212", 10, System.currentTimeMillis() - 50*1000, 1);
        item2 = new LastestBingoEntity(2313,21,21,url5, "title乐视电视descirb2", "小李", "941212", 1, System.currentTimeMillis() - 10*1000, 1);
        item3 = new LastestBingoEntity(23213,21,21, url4, "titledes小米手机irb2", "张李", "321212", 1, System.currentTimeMillis() - 100*1000, 1);
